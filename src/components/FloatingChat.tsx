...
// ==================== مكون الحاسوب ====================
const FloatingChatDesktop = memo(() => {
    ...
    >
      ...
      <div className="relative">
        <button
          ...
          className={cn(
            "relative w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg transition-transform duration-300",
            isOpen
...
export function FloatingChat() {
  ...
  return isMobile ? <FloatingChatMobile /> : <FloatingChatDesktop />;
}
