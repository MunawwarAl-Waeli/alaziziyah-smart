...
//   // دالة المشاركة المحسنة (نسخ الرابط + صورة الغلاف)
//   const handleShare = async () => {
//     const currentUrl = window.location.href;
//     const shareText = `${service.title}\n${service.serviceDetails?.heroSubtitle || ""}\n\nرابط الخدمة: ${currentUrl}`;
//     const coverImageUrl =
...
//       } catch (err) {
//         console.log(
//           "Web Share API failed, falling back to clipboard copy",
//           err,
//         );
//       }
//     }

//     // النسخ الاحتياطي: نسخ الرابط + إظهار إشعار مرئي
//     try {
//       await navigator.clipboard.writeText(currentUrl);
//       setCopySuccess(true);
//       setShowShareTooltip(true);
...
//   return (
//     <main
//       className="min-h-screen bg-background pt-20 pb-24 selection:bg-primary/30 scroll-smooth"
//       dir="rtl"
//     >
//       {/* 1. قسم الهيرو (Hero Section) - محسن للجوال */}
//       <section className="relative w-full h-[40vh] md:h-[60vh] min-h-[350px] md:min-h-[400px] flex items-end pb-8 md:pb-12 overflow-hidden rounded-b-[2rem] md:rounded-b-[4rem] shadow-2xl z-10">
//         <Image
//           src={
//             service.featuredImage?.node.sourceUrl || "/images/placeholder.jpg"
//           }
...
//           unoptimized
//         />
//         {/* تدرج داكن مع تحسين التباين للجوال */}
//         <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-900/70 to-transparent opacity-95 md:opacity-90"></div>
...
//             className="max-w-4xl"
//           >
//             {/* Breadcrumbs - تجاوب ممتاز */}
//             <nav className="flex items-center flex-wrap gap-2 text-slate-300 text-xs md:text-sm font-medium mb-3 md:mb-4 bg-white/5 backdrop-blur-md w-fit px-3 py-1.5 md:px-4 rounded-full border border-white/10">
//               <Link href="/" className="hover:text-primary transition-colors">
//                 الرئيسية
//               </Link>
//               <span className="text-white/30">/</span>
...
//             <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl font-black text-white mb-3 md:mb-4 leading-tight drop-shadow-lg">
//               {service.title}
//             </h1>
//             <p className="text-sm md:text-base lg:text-xl text-slate-200 max-w-2xl leading-relaxed">
//               {service.serviceDetails?.heroSubtitle}
//             </p>
//           </motion.div>
//         </div>
...
//       {/* 2. الحاوية الرئيسية (Grid متجاوبة) */}
//       <div className="container mx-auto px-4 py-8 md:py-16 lg:py-20 flex flex-col lg:flex-row gap-8 md:gap-12 items-start relative z-20 -mt-8 md:-mt-12">
//         {/* القسم الأيمن: المحتوى الرئيسي */}
//         <div className="w-full lg:w-2/3 flex flex-col gap-10 md:gap-14">
//           {/* تفاصيل الخدمة والمميزات */}
//           <section className="bg-card rounded-2xl md:rounded-[2rem] p-5 md:p-8 lg:p-10 shadow-sm border border-border">
//             <div className="flex items-center gap-3 mb-6 md:mb-8 border-b border-border pb-4 md:pb-6">
//               <div className="p-2 bg-primary/10 rounded-xl">
//                 <PenTool className="text-primary w-5 h-5 md:w-6 md:h-6" />
//               </div>
//               <h2 className="text-xl md:text-2xl lg:text-3xl font-black text-foreground">
//                 عن الخدمة
//               </h2>
//             </div>
...
//                     <div
//                       key={idx}
//                       className="bg-card rounded-xl md:rounded-2xl border border-border shadow-sm flex flex-col md:flex-row overflow-hidden hover:shadow-lg hover:border-primary/30 transition-all duration-300 group"
//                     >
//                       {/* الصورة - ارتفاع مناسب للجوال */}
//                       <div className="relative w-full md:w-64 lg:w-72 h-56 md:h-auto bg-muted shrink-0 overflow-hidden">
//                         <Image
//                           src={
...
//                         <h4 className="text-lg md:text-xl lg:text-2xl font-bold text-foreground mb-2 group-hover:text-primary transition-colors">
//                           {type.title}
//                         </h4>
//                         <p className="text-sm md:text-base text-muted-foreground mb-4 leading-relaxed">
//                           {type.description}
//                         </p>
//                         <div className="mt-auto flex items-center gap-2 text-xs md:text-sm font-bold text-primary bg-primary/5 w-fit px-3 py-1.5 md:px-4 md:py-2 rounded-lg border border-primary/10">
//                           <ShieldCheck className="w-3 h-3 md:w-4 md:h-4" /> ضمان
//                           وتصميم معتمد
//                         </div>
//                       </div>
//                     </div>
...
//           {/* معرض الصور - شبكة متجاوبة */}
//           {service.serviceDetails?.gallery &&
//             service.serviceDetails.gallery.length > 0 && (
//               <section className="bg-card p-5 md:p-8 lg:p-10 rounded-xl md:rounded-2xl border border-border shadow-sm">
//                 <div className="flex items-center justify-between mb-5 md:mb-8 pb-4 border-b border-border">
//                   <div className="flex items-center gap-3">
//                     <div className="p-2 bg-primary/10 rounded-xl">
...
//                     <div
//                       key={idx}
//                       className="relative aspect-square rounded-xl md:rounded-2xl overflow-hidden group cursor-zoom-in border border-border shadow-sm"
//                     >
//                       <Image
//                         src={imgUrl}
...
//               <section className="bg-card rounded-xl md:rounded-2xl p-5 md:p-8 lg:p-10 border border-border shadow-sm">
...
//                     <details
//                       key={idx}
//                       className="group border border-border bg-background rounded-xl md:rounded-2xl p-4 md:p-5 [&_summary::-webkit-details-marker]:hidden"
//                     >
//                       <summary className="flex items-center justify-between font-bold text-foreground cursor-pointer list-none hover:text-primary transition-colors text-sm md:text-base">
//                         <span className="pr-2">{faq.question}</span>
//                         <div className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-accent flex items-center justify-center shrink-0 group-open:bg-primary/10 group-open:text-primary transition-colors">
//                           <ChevronDown className="w-4 h-4 md:w-5 md:h-5 transition-transform duration-300 group-open:rotate-180" />
//                         </div>
//                       </summary>
//                       <div className="mt-3 md:mt-4 pt-3 border-t border-border pr-2">
...
//         {/* القسم الأيسر: الشريط الجانبي - متجاوب ويظل ملتصقاً */}
//         <aside className="w-full lg:w-1/3 flex flex-col gap-5 md:gap-6 lg:gap-8 sticky top-28">
//           {/* كرت التواصل الفخم */}
//           <div className="bg-slate-900 rounded-2xl md:rounded-3xl p-6 md:p-8 text-center shadow-2xl relative overflow-hidden border border-slate-800">
//             <div className="absolute top-0 right-0 w-32 h-32 bg-primary/20 rounded-full blur-3xl -mr-10 -mt-10 pointer-events-none"></div>
//             <div className="absolute bottom-0 left-0 w-32 h-32 bg-primary/10 rounded-full blur-3xl -ml-10 -mb-10 pointer-events-none"></div>

//             <div className="w-14 h-14 md:w-16 md:h-16 bg-primary/20 rounded-xl flex items-center justify-center mx-auto mb-4 md:mb-6">
...
//               مهتم بتنفيذ {service.title}؟
//             </h3>
//             <p className="text-slate-400 mb-6 md:mb-8 relative z-10 text-sm md:text-base leading-relaxed">
//               تواصل معنا الآن للحصول على استشارة هندسية مجانية، مقاييس دقيقة،
//               وعرض سعر مخصص لمشروعك.
//             </p>
...
//             {/* زر المشاركة المحسن مع عرض الرابط */}
...
//               {/* أداة عرض الرابط مع زر نسخ */}
//               {showShareTooltip && (
//                 <div className="absolute bottom-full left-0 right-0 mb-2 p-3 bg-slate-800 rounded-xl shadow-xl border border-slate-700 z-30 text-right">
//                   <div className="flex items-center gap-2 bg-slate-900 rounded-lg p-2 border border-slate-700">
//                     <input
//                       type="text"
//                       readOnly
...
//           {/* خدمات ذات صلة */}
//           {relatedServices.length > 0 && (
//             <div className="bg-card rounded-2xl md:rounded-3xl p-5 md:p-6 shadow-sm border border-border">
//               <h3 className="text-base md:text-lg font-black text-foreground mb-4 border-b border-border pb-3 flex items-center gap-2">
//                 <Layers className="w-4 h-4 md:w-5 md:h-5 text-primary" /> خدمات
//                 ذات صلة
//               </h3>
...
//                     <Link
//                       href={`/services/${s.slug}`}
//                       className="flex items-center justify-between p-3 rounded-xl hover:bg-accent border border-transparent hover:border-border transition-all group"
//                     >
//                       <span className="flex items-center gap-2 font-bold text-sm text-foreground group-hover:text-primary transition-colors">
//                         <div className="w-7 h-7 rounded-lg bg-background flex items-center justify-center group-hover:bg-primary/10 transition-colors shrink-0">
//                           <ShieldCheck className="w-3 h-3 md:w-4 md:h-4 text-muted-foreground group-hover:text-primary" />
//                         </div>
//                         {s.title}
//                       </span>
//                       <ArrowLeft className="w-3 h-3 md:w-4 md:h-4 text-muted-foreground opacity-0 group-hover:opacity-100 group-hover:-translate-x-1 transition-all" />
//                     </Link>
//                   </li>
//                 ))}
//               </ul>
...
//           {/* كرت الموقع الجغرافي */}
//           <div className="bg-card rounded-2xl md:rounded-3xl p-5 shadow-sm border border-border text-center overflow-hidden">
//             <div className="relative w-full h-32 md:h-40 bg-muted rounded-xl mb-4 overflow-hidden border border-border group cursor-pointer">
//               <Image
//                 src="/images/0.jpg"
//                 alt="موقعنا"
//                 fill
...
//                 <span className="bg-background/90 backdrop-blur-md text-foreground font-bold text-[10px] md:text-xs py-1.5 px-3 rounded-full shadow-lg flex items-center gap-1 border border-border">
//                   <MapPin className="w-3 h-3 text-primary" /> عرض على الخريطة
//                 </span>
//               </div>
//             </div>
