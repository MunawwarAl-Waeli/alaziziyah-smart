...
console.log("البيانات الواصلة للمكون الديناميكي:", posts);  // 1. التأكد أن posts هي دائماً مصفوفة قبل أي عمليات
...
// } from "lucide-react";
// import { ElegantCurveDivider } from "@/components/ui/ElegantCurveDivider";
// // ✅ استيراد نوع البيانات بدلاً من البيانات الثابتة
// import { BlogPost } from "@/app/blog/types/bolg.types";

// // ✅ تعريف الـ Props لتستقبل المقالات من السيرفر
// interface BlogSectionProps {
//   posts: BlogPost[];
// }

// export function BlogSection({ posts }: BlogSectionProps) {
//   // أخذ أحدث 3 مقالات (في حال تم تمرير كل المقالات)
...
//   // تنسيق التاريخ مع حماية (Fallback) في حال كان فارغاً
//   const formatDate = (dateString?: string) => {
//     if (!dateString) return "حديث";
//     return new Date(dateString).toLocaleDateString("ar-SA", {
//       year: "numeric",
...
//   if (!posts || posts.length === 0) return null; // إخفاء القسم إذا لم توجد مقالات
