...
export const metadata: Metadata = {
  title: "اتصل بنا | مؤسسة العزيزية للمظلات والسواتر",
  description:
    "تواصل مع مؤسسة العزيزية في جدة لطلب استشارة مجانية أو عرض سعر لتركيب المظلات، السواتر، والبرجولات. فريقنا الهندسي في خدمتك.",
  keywords:
    "رقم شركة مظلات, التواصل مع العزيزية, طلب عرض سعر مظلات, موقع شركة العزيزية بجدة",
  alternates: {
    canonical: `${siteConfig.url}/contact`,
  },
  openGraph: {
    title: "اطلب عرض سعر مجاني | العزيزية للمظلات",
    description: "تواصل معنا الآن لتحويل أفكارك إلى واقع بأعلى معايير الجودة.",
...
export default function ContactPage() {
  // 🚀 السلاح السري: سكيما صفحة التواصل (ContactPage Schema)
  const contactSchema = {
    "@context": "https://schema.org",
    "@type": "ContactPage",
    name: "اتصل بمؤسسة العزيزية",
    description: "صفحة التواصل لطلب خدمات تركيب المظلات والسواتر",
    url: `${siteConfig.url}/contact`,
    mainEntity: {
  ...
  return (
    <>
      ...
      />
      {/* استدعاء مكون العميل الذي يحتوي على الفورم */}
      <ContactClient />
    </>
  );
}
