              ...
              {!showResult ? (
                ...
                calculationResult && (
                  ...
                  >
                    ...
                    <div className="bg-gradient-to-br from-primary to-primary-dark text-white p-6 md:p-8 rounded-3xl text-center shadow-xl shadow-primary/20 relative overflow-hidden isolate">
